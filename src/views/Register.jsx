...
//           <button
//             type="submit"
//             className="btn-2 w-full py-3 font-semibold text-white bg-blue-600 rounded hover:bg-blue-700 transition-colors duration-300"
//           >
//             Register
//           </button>
//           {err && <p className="text-red-500">{typeof err === "string" ? err : JSON.stringify(err)}</p>}
//           <span className="block text-center">
//             Do you have an account? <Link to="/login" className="text-blue hover:underline">Login</Link>
//           </span>
//         </form>
//       </div>
//     </div>
