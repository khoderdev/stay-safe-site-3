...
import Spherical from '../components/dx-prevention/Spherical';
...
export default function Home() {
  ...
  return (
    <div className="flex flex-col">
      ...
      <div ref={(el) => (sectionsRef.current[2] = el)} className="section bg-white-fg dark:bg-[#000]">
        {/* <Spherical /> */}
      </div>
      <div ref={(el) => (sectionsRef.current[3] = el)} className="section bg-white-fg dark:bg-black">
        <SearchPharmacies />
      </div>
      <div ref={(el) => (sectionsRef.current[4] = el)} className="section bg-white-fg dark:bg-black">
        <PackYearsCalculator />
      </div>
