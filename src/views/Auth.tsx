...
const Auth = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center dark:bg-dark p-4">
      <motion.div
        initial={{ opacity: 0, y: 20 }}
        animate={{ opacity: 1, y: 0 }}
        className="w-full max-w-md"
      >
        <div className="bg-white-bg dark:bg-black rounded-2xl shadow-xl overflow-hidden">
          ...
          <div className="p-6">
            ...
            <form onSubmit={handleSubmit}>
              {!isLogin && (
                <div className="mb-4">
                  <label className="block text-lg  dark:text-gray-50 mb-1">
                    Username
                  </label>
                  <input
                    type="text"
              ...
              <button
                ...
                className="w-full bg-gray-200  py-2 rounded-lg5over:bg-gray-300 transition-colors mb-4"
              >
                Use Test Account
              </button>
