...
//             <MedicalAssessment formData={formData}
//               setFormData={setFormData}
//               nextStep={nextStep}
//             />
//           </div>
...
//           </div>
//         )}
//         {currentStep === 3 && <div className="space-x-4">
//           <div className="space-x-4">
...
//         </div>
//         }
//         {currentStep === 4 && <div className="space-x-4">
//           <div className="space-x-4">
...
//         </div>
//         }
//         {currentStep === 5 && <div className="space-x-4">
...
//           />
//         </div>}
//         {currentStep === 6 && <div className="space-x-4">
//           <Goals
//             formData={formData}
//             setFormData={setFormData}
//             nextStep={nextStep}
...
//       {/* Navigation buttons */}
//       <div className="button-group flex  justify-center space-x-8">
//         {currentStep > 0 && (
