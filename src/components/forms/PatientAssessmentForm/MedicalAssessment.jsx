    ...
    <form onSubmit={handleSubmit} className="">
      ...
      <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3'>
        ...
        <div className="flex flex-col p-4">
          <label className="font-semibold mb-2">Past Medical History (PMH)</label>
          <input
        ...
        <div className="flex flex-col p-4">
          <label className="font-semibold mb-2">Past Surgical History (PSH)</label>
          <input
        ...
        <div className="flex flex-col p-4">
          <label className="font-semibold mb-2">Food Intolerance</label>
          <input
            type="text"
        ...
        <div className="flex flex-col p-4">
          <label className="font-semibold mb-2">Food Allergies</label>
          <select
            name="foodAllergies"
        ...
        <div className="flex flex-col p-4">
          <label className="font-semibold mb-2">Medication/Supplements, Specify</label>
          <input
            type="text"
            name="medications"
        ...
        <div className="flex flex-col p-4">
          <label className="font-semibold mb-2">Do you Smoke?</label>
          <select
            name="smokingStatus"
        ...
        {formData.smokingStatus === 'yes' && (
          <>
            <div className="flex flex-col p-4">
              <label className="font-semibold mb-2">How many packs a day? (pack 20 cigarettes)</label>
              <input
                type="number"
                name="packsPerDay"
            ...
            <div className="flex flex-col p-4">
              <label className="font-semibold mb-2">How many smoking years?</label>
              <input
                type="number"
                name="smokingYears"
        ...
        <div className="flex flex-col p-4">
          <label className="font-semibold mb-2">Do you drink alcohol?</label>
          <select
            name="drinkingStatus"
        ...
        {formData.drinkingStatus === 'yes' && (
          <>
            <div className="flex flex-col p-4">
              <label className="font-semibold mb-2">How often do you drink alcohol?</label>
              <select
            ...
            <div className="flex flex-col p-4">
              <label className="font-semibold mb-2">How many drinks do you take per day?</label>
              <select
                name="typicalDrinks"
        ...
        <div className="flex flex-col p-4">
          <label className="font-semibold mb-2">Family History</label>
          <input
            name="familyHistory"
