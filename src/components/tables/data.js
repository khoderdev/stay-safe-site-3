...
export const data = [
...

	{
		...
		prevention: `You can lower your risk of intestinal Bacillus cereus by storing your food safely. Steps you can take include:
...
`,
...

	{
		...
		causes: `Processed, ready-to-eat products such as undercooked hot dogs, deli or lunchmeat, and unpasteurized dairy products; post pasteurization contamination of soft cheeses such as feta or Brie, milk, and commercial coleslaw; cross-contamination between food surfaces has also been a problem.
`,
		prevention: `Use pasteurized milk and cheeses; wash produce before use; reheat foods to proper temperatures; wash hands with hot, soapy water after handling these ready-to-eat foods; discard foods by their expiration dates.`,
		comments: `May be fatal
...
Stay home when sick for 2 days (48 hours) after symptoms stop.`,
		comments: `Norovirus is very contagious, but you can take steps to protect yourself and others, including:
Wash your hands well and often.
Cook shellfish thoroughly and wash fruits and vegetables.
Clean and disinfect contaminated surfaces.
Wash laundry in hot water.
Stay home when sick for 2 days (48 hours) after symptoms stop.`,
...

	{
		...
		causes: `Ingestion of raw or undercooked meat, poultry, fish, eggs, unpasteurized dairy products; unwashed fruits and raw vegetables (melons and sprouts)
`,
		prevention: `Prevent by thorough cooking, proper sanitation, and hygiene.`,
		comments: `There are many different kinds of Salmonella bacteria;
Most people recover without treatment, but some have diarrhea that is so severe that the patient needs to be hospitalized; this patient must be treated promptly with antibiotics; the elderly, infants, and those with impaired immune systems are more likely to have a severe illness.`,
...

	{
		...
		causes: `Contaminated Milk and dairy products, cold mixed salads such as egg, tuna, chicken, potato, and meat salads. Uncooked vegetables or shellfish`,
		prevention: `Proper cooking, reheating, and maintenance of holding temperatures should aid in prevention; careful hand washing is essential.`,
		comments: `This is caused by a group of bacteria called Shigella, it may be severe in young children and the elderly: severe infection with high fever may be associated with seizures in children younger than 2 years old.`,
	},

	{
		...
		causes: `Meat, pork, eggs, poultry, tuna salad, prepared salads, gravy, stuffing, cream-filed pastries
`,
		prevention: `Cooling does not destroy the toxin; proper handing and hygiene are crucial for prevention.`,
		comments: `Refrigerate foods promptly during preparation and after meal service`,
	},

	{
		...
		causes: `Entrance into the food is the result of poor hygiene, ill food handlers, or
...
`,
	...
	},
	{
		...
		comments: `This is a bacterium in the same family as those that cause cholera, it yields a Norovirus, it may be fatal in immunocompromised individuals.
`,
	},
	{
...
Hand washing. Wash your hands thoroughly with soap and water for 20 seconds after handling raw meat. This can prevent spreading infection to other food.`,
		coments: `Trichinella Spiralis parasites infect animals such as bears, cougars, walruses, foxes, wild boars and domestic pigs`,
	},
];
