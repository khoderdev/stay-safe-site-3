...
const PHQ9Quiz = () => {
  ...
  const calculateScore = () => {
    const calculatedScore = Object.entries(answers).reduce(
  ...
  const getScoreInterpretation = (score) => {
    for (let interpretation of scoreInterpretation) {
      if (
        score >= interpretation.range[0] &&
        score <= interpretation.range[1]
      ) {
  ...
  return (
    <div className="flex flex-col justify-between place-self-center ">
      <div className="quiz-container mb-4 flex justify-center">
        {score === null ? (
          <div className="w-full">
            ...
            <h1 className="text-black text-center dark:text-white-bg text-xl pt-4 mb-2">
              Over the last two weeks, how often have you <br /> been bothered
      ...
      <div className="  text-black dark:text-white-bg w-full flex flex-col justify-center">
