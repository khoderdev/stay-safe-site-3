...
// // //   // Stagger animation for additional text when clicked
...
// // //         >
// // //           <motion.div className='col-span-8 row-span-1 col-start-3 text-3xl pt-8 sm:text-4xl md:text-3xl dark:text-white-bg2'>
// // //             <motion.div
// // //               className=" "
...
// // //             >
// // //               BE <span className='underline mt-1 cursor-pointer'>ANTIBIOTICS</span> AWARE
// // //             </motion.div>
// // //             {/* Additional text animation on visibility */}
// // //             <motion.div
// // //               className=''
...
// // //             >
// // //               <p className='text-xl py-4 px-2 drop-shadow-md rounded-b pt-4 text- dark:!bg-[#000] opacity-1 z-40 relative flex flex-col px- sm:w-[83%] md:w-[36%] place-self-center'>
...
// // //           <motion.div
// // //             className="col-span-4 row-span-3 col-start-5 row-start-2 text-[10.5rem] flex justify-center items-end font-bold text-[#d23c88]"
// // //             initial={{ opacity: 0 }}
...
// //   const containerRef = useRef(null); // Reference to the container that toggles visibility
// //   const offset = { x: -20, y: -0 };
// //   const [isVisible, setIsVisible] = useState(false);
...
// //   // Handle click outside to hide content
// //   useEffect(() => {
...
// //         >
// //           <motion.div 
// //             className='col-span-8 row-span-1 col-start-3 text-3xl pt-8 sm:text-4xl md:text-3xl dark:text-white-bg2'
// //             ref={containerRef} // Attach the ref to this container
// //           >
// //             <motion.div
// //               className=" "
// //               onClick={toggleVisibility}
...
//   const { mouseX, mouseY } = useMousePosition();
//   const imageRef = useRef(null);
//   const containerRef = useRef(null); // Reference to the container for hover events
//   const offset = { x: -20, y: -0 };
//   const [isVisible, setIsVisible] = useState(false);
...
//             className='col-span-8 row-span-1 col-start-3 text-3xl pt-8 sm:text-4xl md:text-3xl dark:text-white-bg2'
//             ref={containerRef} // Attach the ref to this container
//             onMouseEnter={handleMouseEnter} // Show text on hover
//             onMouseLeave={handleMouseLeave} // Hide text when hover ends
//           >
//             <motion.div
//               className=" "
//               initial={{ opacity: 0, y: 20 }}
...
//               BE <span className='underline mt-1 cursor-pointer'>ANTIBIOTICS</span> AWARE
//             </motion.div>
//             {/* Additional text animation on hover */}
//             <motion.div
//               className=''
//               initial={{ height: 0, opacity: 0 }}
//               animate={{
    ...
    <motion.div className='section relative flex flex-col !z-30 overflow-hidden select-none bg-white-fg dark:bg-black'>
      <motion.div>
        ...
        >
          ...
          {/* <motion.div
            className="col-span-2 col-start-3 row-start-4 border font-normal flex items-center justify-end"
            variants={fadeInVariant}
          >
            at the
          </motion.div>
          <motion.div
            className="col-span-2 col-start-3 row-start-5 border font-normal flex items-center justify-end"
            variants={fadeInVariant}
          >
            for the
          </motion.div> */}
          ...
          {/* <motion.div
            className="col-span-2 col-start-9 row-start-4 border font-normal flex items-center justify-start"
            variants={fadeInVariant}
          >
            dose
          </motion.div>
          <motion.div
            className="col-span-2 col-start-9 row-start-5 border font-normal flex items-center justify-start"
            variants={fadeInVariant}
          >
            duration
          </motion.div> */}
