          ...
          >
            ...
            <AnimatePresence>
              {isVisible && (
                ...
                >
                  <p className='text-xl py-4 px-2 drop-shadow-md rounded-sm pt-4 text-center dark:bg-[#000]! opacity-1 z-40 relative flex flex-col w-[88%] sm:w-[70%] md:w-[34%]  sm:mx-0 place-self-center'>
