...
const ServiceAnimatedCard = ({
	...
	return (
		...
		>
			...
			<h3 className='absolute bottom-10 group-hover:absolute group-hover:top-[180px] group-hover:mb-0 group-hover:opacity-100 text-left text-2xl px-6 font-bold text-black dark:text-white-bg z-50 dark:text-white transition-transform duration-300 transform group-hover:translate-y-[-100%] mb-4'>
				{title}
			</h3>
