const Clinic = ({
	...
	return (
		...
		>
			...
			<h3 className='absolute bottom-10 group-hover:absolute group-hover:top-[155px] group-hover:mb-0 group-hover:opacity-100 text-left text-3xl px-6 font-bold text-black dark:text-white-bg z-50 dark:text-white transition-transform duration-300 transform group-hover:translate-y-[-20%] mb-4'>
				Clinic Consultation
			</h3>
