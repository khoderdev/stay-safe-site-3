...
// //   return (
// //     <div className="flex w-full justify-between p-6 bg-white dark:bg-[#000] overflow-x-hidden overflow-y-hidden border-2 border-yellow-500">

// //       <div className="content rounded-lg p-4 shadow-md transition-all duration-300 bg-[#f0f0fe] dark:bg-black text-black dark:text-[#f0f0fe] border border-green-500">
// //         <input
// //           type="text"
// //           placeholder="Title"
// //           required
...
// //       <div className="preview border w-96"></div>
...
// //             <b className="">Status: </b> Draft
// //           </span>
// //           <span className="block">
// //             <b className="">Visibility: </b> Public
// //           </span>

// //           <label
// //             className="file underline py-1 text-blue "
// //             htmlFor="file"
// //           >
// //             Upload Image
...
// //         <div className="item dark:bg-black text-black dark:text-[#f0f0fe] p-4 rounded-md shadow-sm transition-transform duration-200 hover:scale-105 ">
// //           <h1 className="font-semibold text-lg dark:text-white">Category</h1>
// //           <div className="cat">
...
// //                   className="mr-2 accent-blue-500 dark:accent-blue-300 transition-colors duration-200"
// //                 />
// //                 <label htmlFor={category} className="text-black dark:text-[#f0f0fe] ">
