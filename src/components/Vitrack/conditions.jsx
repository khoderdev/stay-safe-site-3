...
// 	// Filter the symptomsList to include only the relevant emergency symptoms
// 	const emergencySymptoms = symptomsList.filter((symptom) =>
// 		[
// 			'Rapid, shallow breathing',
// 			'Breathing Fast',
...
// 	// Check if BP is in any of the specified ranges AND has emergency symptoms
// 	if (
...
// 		hasSevereSymptoms(emergencySymptoms)
// 	) {
// 		addMessage(
// 			'Get Immediate Medical Attention. Call an ambulance and go to the emergency department right away.',
// 			'red'
...
// 		}
// 	} else if (
// 		// New condition: Diastolic from 80 to 89 (regardless of systolic)
// 		diastolic >= BP_THRESHOLDS.ELEVATED_DIASTOLIC &&
// 		diastolic < BP_THRESHOLDS.HIGH_DIASTOLIC_STAGE2
// 	) {
// 		addMessage(
// 			'High Blood Pressure (Stage 1): Get Evaluated, Call your healthcare provider right away. Keep monitoring your Blood Pressure.',
// 			'orange'
// 		);
// 		if (hasSevereSymptoms(elevatedBPSymptoms)) {
// 			addMessage(
// 				'High Blood Pressure (Stage 1) with Severe Symptoms: Get Immediate Medical Attention. Call an ambulance and go to the emergency department right away.',
// 				'red'
// 			);
// 		}
// 	} else if (
// 		systolic >= BP_THRESHOLDS.HIGH_SYSTOLIC_STAGE1 &&
// 		systolic < BP_THRESHOLDS.HIGH_SYSTOLIC_STAGE2 // From 130 to 139 (only systolic)
// 	) {
// 		addMessage(
// 			'High Blood Pressure (Stage 1): Get Evaluated, Call your healthcare provider right away. Keep monitoring your Blood Pressure.',
// 			'orange'
...
// 	) {
// 		// Stage 2 High Blood Pressure (only systolic)
// 		if (hasSevereSymptoms(elevatedBPSymptoms)) {
// 			addMessage(
...
// 		} else {
// 			addMessage(
// 				'High Blood Pressure (Stage 2): Get Evaluated, Call your healthcare provider right away. Keep monitoring your Blood Pressure.',
// 				'orange'
// 			);
// 		}
// 	} else if (
...
import { symptomsList } from './data'; // Import the full symptoms list
...
export const handleBloodPressure = (
	...
	const severeSymptoms = symptomsList;
	...
	// Check if BP is in any of the specified ranges AND has any symptoms
	if (
		(systolic >= BP_THRESHOLDS.ELEVATED_SYSTOLIC ||
			diastolic >= BP_THRESHOLDS.ELEVATED_DIASTOLIC ||
			systolic >= BP_THRESHOLDS.HIGH_SYSTOLIC_STAGE1 ||
			...
			systolic >= BP_THRESHOLDS.HIGH_SYSTOLIC_STAGE2 ||
			diastolic >= BP_THRESHOLDS.HIGH_DIASTOLIC_STAGE2) &&
		hasSevereSymptoms(symptomsList) // Use the full symptomsList
	) {
		addMessage(
			'Get Immediate Medical Attention. Call an ambulance and go to the emergency department right away.',
			'red'
