...
function HandMonsterPage() {
  return (
    <div className="md:flex items-center">
      ...
      />
      <div className="w-full md:w-[40%] mt-16 md:mt-0 dark:text-white-bg p-6">
        ...
        <p className="text-[25px]">
          Keep them clean and safe by washing with soap and water regularly for
          at least 20 seconds to protect yourself and others from illness!
        </p>
      </div>
    </div>
  );
