...
//         <h1 className="text-3xl font-semibold mb-8 text-center text-black dark:text-[#f0f0ee]">Mediterranean Diet Score</h1>
...
//               <label className="flex items-center space-x-2 text-black dark:text-[#f0f0ee]">
//                 <input
//                   type="radio"
