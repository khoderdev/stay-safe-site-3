...
export default function Header() {
  ...
  const dropdownItems = [
    { label: 'Vitrack', href: '/vitrack' },
    ,
  ];

  return (
    <header ref={headerRef} className="bg-white-fg dark:bg-black shadow-md dark:shadow-[#00000021] relative z-40 flex items-center justify-between lg:pl- lg:pr-6">
      {/* Logo */}
      <motion.div
        className="flex-shrink-0 pl-2"
        initial={{ opacity: 0, scale: 0.5 }}
      ...
      <div className='flex justify-between items-center space-x-10'>
        ...
        >
          ...
          <Dropdown title="Preventive Health & Patient Services" items={dropdownItems} />
          <Link
            to="/preventive-health-patient-services"
            className="text-black hover:text-blue dark:text-white-bg dark:hover:text-blue transition-colors">
