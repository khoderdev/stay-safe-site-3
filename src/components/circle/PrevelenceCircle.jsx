...
function PrevelenceCircle({ scrollContainerRef }) {
	...
	return (
		<>
			<div className='relative z-30 flex flex-col items-center justify-center w-full h-[220dvh]  bg-black -2 border-pink'>
				...
				<motion.div
					...
					className='absolute w-[80%] sm:w-[43%] md:w-[60%] xl:w-[55%] h-auto rounded-full flex items-center justify-center'
				>
					<SmallCircle />
				</motion.div>
				{/* <CTA /> */}
