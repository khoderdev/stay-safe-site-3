...
//             perspective: 800,
//           }}
//           className="absolute w-full h-full 2xl:w-[70dvw] 2xl:h-[80dvh] flex items-center justify-center z-40"
//         >
//           <SmallCircle />
//         </motion.div>
	...
	return (
		<div className='w-full h-full flex flex-col'>
			...
			<div className='relative z-40 flex flex-col items-center justify-center w-full min-h-screen md:h-[200dvh] overflow-hidden'>
				...
				{/* Text Content */}
				<div className='w-[90%] sm:w-[80%] md:w-[70%] lg:w-[60%] xl:w-[50%] 2xl:w-[50%] flex flex-col sm:flex-row items-center justify-center gap-4 sm:gap-8 md:gap-12 lg:gap-16 xl:gap-20 z-40'>
