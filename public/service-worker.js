...
// Function to dynamically discover and cache static assets
const cacheStaticAssets = async () => {
	const cache = await caches.open(CACHE_NAME);

	// Fetch a list of static assets (e.g., from a manifest or directory)
	const staticAssets = await fetch('/static-manifest.json').then((response) =>
		response.json()
	);
